...
const Home = () => {
  ...
  const handleTestDownload = () => {
    ...
    .then(async (response) => {    
      ...
      const keysNames = Object.keys(paySlipDataMain).map(thi => thi);
      console.log('Data:', keysNames);
    }).catch((error) => {
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }} border='1'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Wages Earned"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}>EPF</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["EPF"]).toFixed(2))}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>OT Amount</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["OT Amount"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}>Mess</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Mess"]).toFixed(2))}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>H Allowance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["H Allowance"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}>Advance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Advance"]).toFixed(2))}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>S Allowance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["S Allowance"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}>TDS</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["TDS"]).toFixed(2))}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>Bonus @ 8.33%</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Bonus @ 8.33%"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}></td>
                    <td style={{ padding: "5px" }}></td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>Area Allowance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Area Allowance"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}></td>
                    <td style={{ padding: "5px" }}></td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>Washing Allowance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Washing Allowance"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}></td>
                    <td style={{ padding: "5px" }}></td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px" }}>Performance Allowance</td>
                    <td style={{ padding: "5px", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Performance Allowance"]).toFixed(2))}</td>
                    <td style={{ padding: "5px" }}></td>
                    <td style={{ padding: "5px" }}></td>
                  </tr>
                  <tr>
                    <td style={{ padding: "5px", fontWeight: "bold" }}>GROSS AMT</td>
                    <td style={{ padding: "5px", fontWeight: "bold", textAlign: 'right' }}>{formatCurrency(Number(payslipData["GROSS AMT"]).toFixed(2))}</td>
                    <td style={{ padding: "5px", fontWeight: "bold" }}>Total Deduction</td>
                    <td style={{ padding: "5px", fontWeight: "bold", textAlign: 'right' }}>{formatCurrency(Number(payslipData["Total Deduction"]).toFixed(2))}</td>
                  </tr>
                  <tr>
